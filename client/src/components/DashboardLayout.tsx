...
import { LayoutDashboard, LogOut, PanelLeft, Users, AlertCircle, FileText, Shield, Settings, Camera, Eye, AlertTriangle, Film } from "lucide-react";
...
const getMenuItems = (isAdmin: boolean) => {
  const baseItems = [
    ...
    { icon: Eye,      label: "Live Alerts Feed",   path: "/alerts" },
    { icon: Film,     label: "Motion Detections",  path: "/movements" },
    { icon: FileText, label: "Event Log",           path: "/events" },
  ];
  ...
  return [...baseItems, ...(isAdmin ? adminItems : [])]
};
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-6">
            <h1 className="text-2xl font-semibold tracking-tight text-center text-primary">
              BlueEye
            </h1>
                  ...
                  <SidebarMenuItem key={item.path}>
                    <SidebarMenuButton
                      ...
                      className={`h-10 transition-all font-normal ${
                        isActive ? "bg-primary/10 text-primary" : "text-sidebar-foreground hover:bg-sidebar-accent/10"
                      }`}
                    >
                      <item.icon
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-3">
                <div className="flex flex-col gap-1">
                  <span className="tracking-tight text-foreground font-bold text-primary">
                    {activeMenuItem?.label ?? "BlueEye"}
                  </span>
                </div>
              </div>
            </div>
